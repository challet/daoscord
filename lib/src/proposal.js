...
export const createProposal = async (aragonTokenVotingClient, description, endDate) => {
    ...
    // Fails because the signer (admin) has not enough reputation
   // https://github.com/aragon/osx/blob/873cf252ec92e5f54662d0364e141e7b16348217/packages/contracts/src/plugins/governance/majority-voting/token/TokenVoting.sol#L92
